...
import me.jack.ld41.Weapon.Projectiles.AdvancedSmallBullet;
 ...
 */
public class AdvancedTurret extends Weapon {

    private float rotation;

    public AdvancedTurret(int x, int y) throws SlickException {
        super("Z3I5-2", WeaponType.GUN, 1, 0, x, y);
    ...
    public void fire(int aX, int aY,Level level,int tX,int tY) throws SlickException {
        ...
        level.addProjectile(new AdvancedSmallBullet(),rX,rY,tX,tY);
        lookAt(rX,rY,tX,tY);
    }
