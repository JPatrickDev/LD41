...
import me.jack.ld41.Weapon.Projectiles.Missile;
 ...
 */
public class AdvancedMissleLauncher extends Weapon {

    private float rotation;

    public AdvancedMissleLauncher(int x, int y) throws SlickException {
        super("BXDA-1", WeaponType.GUN, 0, 2, x, y);
    ...
    public void fire(int aX, int aY, Level level, int tX, int tY) throws SlickException {
        ...
        level.addProjectile(new Missile(), rX - 16, rY, tX, tY);
        level.addProjectile(new Missile(), rX + 16, rY, tX, tY);
        lookAt(rX, rY, tX, tY);
    }
