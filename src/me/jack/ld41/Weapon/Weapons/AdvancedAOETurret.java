 ...
 */
public class AdvancedAOETurret extends Weapon {

    private float rotation;

    public AdvancedAOETurret(int x, int y) throws SlickException {
        super("CXEA-2", WeaponType.GUN, 1, 2, x, y);
    ...
    public void fire(int aX, int aY, Level level, int tX, int tY) throws SlickException {
        ...
        level.addProjectile(new BasicSmallBullet(), rX - 16, rY, rX - 32, rY);
        level.addProjectile(new BasicSmallBullet(), rX + 16, rY, rX + 32, rY);
        level.addProjectile(new BasicSmallBullet(), rX, rY - 16, rX, rY - 32);
        level.addProjectile(new BasicSmallBullet(), rX, rY + 16, rX, rY + 32);

        level.addProjectile(new BasicSmallBullet(), rX - 16, rY - 16, rX - 32, rY - 32);
        level.addProjectile(new BasicSmallBullet(), rX + 16, rY - 16, rX + 32, rY - 32);
        level.addProjectile(new BasicSmallBullet(), rX + 16, rY + 16, rX + 32, rY + 32);
        level.addProjectile(new BasicSmallBullet(), rX - 16, rY + 16, rX - 32, rY + 32);
        lookAt(rX, rY, tX, tY);
